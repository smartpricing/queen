<template>
  <div class="threadpool-chart">
    ...
    <div class="flex items-center gap-1.5 flex-wrap mb-2">
      ...
      >
        <div :class="['metric-dot', selectedMetrics.systemPoolSize ? 'bg-orange-500' : 'bg-gray-400']"></div>
        System Pool Size
      </button>
      <button
...
const replicaColors = [
  { dbPool: 'rgba(107, 114, 128, 1)', dbQueue: 'rgba(245, 158, 11, 1)', sysPool: 'rgba(255, 107, 0, 1)', sysQueue: 'rgba(34, 197, 94, 1)' },
