...
# Queen server
docker run -it -p 6633:6632 --network queen -e PG_HOST=postgres -e PG_PORT=5432 -e PG_USER=postgres -e PG_PASSWORD=postgres -e PG_DB=postgres  -e DB_POOL_SIZE=20 -e NUM_WORKERS=2 smartnessai/queen-mq:0.5.0
```
